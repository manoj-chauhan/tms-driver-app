...
fun AddNoticeEvent() {
    ...
    var selectedNoticeImageUri by remember { mutableStateOf<Uri?>(null) }
...
//        ActivityResultContracts.PickVisualMedia(ActivityResultContracts.PickVisualMedia.ImageOnly)
                ActivityResultContracts.PickVisualMedia()
    ) { uri: Uri? ->
        selectedNoticeImageUri = uri
...
//        coverImage=null
    ...
    LazyColumn(
        ...
        item {
            ...
            selectedNoticeImageUri?.let { uri ->
            ...
            Button(
//                onClick = {
//                    val byteArray = selectedNoticeImageUri?.let { convertUriToByteArray(context, it) }
//                    if (byteArray != null) {
//                        Toast.makeText(context, "Byte array generated successfully", Toast.LENGTH_SHORT).show()
//                    } else {
//                        Toast.makeText(context, "Failed to generate byte array", Toast.LENGTH_SHORT).show()
//                    }
//                },
                onClick = { noticeImage.value?.let {
