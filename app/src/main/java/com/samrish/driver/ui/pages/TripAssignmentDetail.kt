...
import com.samrish.driver.ui.components.generateCode

@Composable
fun TripAssignmentDetails(tripList:List<TripsAssigned> ){
    tripList.forEach { trip -> AssignmentTrips(trip) }
}

@Composable
fun AssignmentTrips(trip: TripsAssigned) {
    Box(
        modifier = Modifier
            .fillMaxWidth()
            .padding(13.dp)
