...
class TripListRequest(
    ...
    listener: Response.Listener<List<CurrentAssignmentDetail>>,
    errorListener: Response.ErrorListener
) : GenericRequest<List<CurrentAssignmentDetail>>(Method.GET, url, headers, listener, errorListener) {
    override fun transformResponse(response: NetworkResponse?): List<CurrentAssignmentDetail> {
        ...
        val mutableList = mutableListOf<CurrentAssignmentDetail>()
...
//            }
            ...
            mutableList.add(CurrentAssignmentDetail(
